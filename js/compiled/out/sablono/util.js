...
var len__19529__auto___21281 = arguments.length;
var i__19530__auto___21282 = (0);
while(true){
if((i__19530__auto___21282 < len__19529__auto___21281)){
args__19536__auto__.push((arguments[i__19530__auto___21282]));

var G__21283 = (i__19530__auto___21282 + (1));
i__19530__auto___21282 = G__21283;
continue;
} else {
}
break;
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq21280){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq21280));
});
/**
...
var vec__21285 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__21285,(0),null);
var words = cljs.core.nthnext.call(null,vec__21285,(1));
...
var G__21287 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__21287,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__21287;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__21288_SHARP_){
if(typeof p1__21288_SHARP_ === 'string'){
return p1__21288_SHARP_;
} else {
return cljs.core.seq.call(null,p1__21288_SHARP_);
...
//# sourceMappingURL=util.js.map?rel=1506396184348