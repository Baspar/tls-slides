...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__21291_SHARP_){
return ((p1__21291_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__21291_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__21293,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__21293;
}
});
...
var len__19529__auto___21296 = arguments.length;
var i__19530__auto___21297 = (0);
while(true){
if((i__19530__auto___21297 < len__19529__auto___21296)){
args__19536__auto__.push((arguments[i__19530__auto___21297]));

var G__21298 = (i__19530__auto___21297 + (1));
i__19530__auto___21297 = G__21298;
continue;
} else {
}
break;
...
var G__21295 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__21295,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__21295;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq21294){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq21294));
});
/**
...
var vec__21302 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__21302,(0),null);
var names = cljs.core.nth.call(null,vec__21302,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__21302,tag_name,names){
return (function (p1__21299_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__21299_SHARP_));
});})(matches,vec__21302,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__21302,tag_name,names){
return (function (p1__21300_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__21300_SHARP_));
});})(matches,vec__21302,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__21303){
var vec__21306 = p__21303;
var tag = cljs.core.nth.call(null,vec__21306,(0),null);
var content = cljs.core.nthnext.call(null,vec__21306,(1));
...
var vec__21307 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__21307,(0),null);
var id = cljs.core.nth.call(null,vec__21307,(1),null);
var class$ = cljs.core.nth.call(null,vec__21307,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1506396184448